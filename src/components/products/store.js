...
export class Category extends Component {
    ...
    render() {
        ...
        return (
            <Fragment>
            <Breadcrumb title="Store" parent="Paylix Club" />
        ...
        <div className="card-body">
            ...
            <button type="button" className="btn btn-primary" onClick={this.onOpenModal} data-toggle="modal" data-original-title="test" data-target="#exampleModal">Add Store</button>
